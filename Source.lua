...
function Window:Notify(Configs)
    ...
    local DropdownFrame = InsertTheme(Create("Frame", Window.Page, {
    ...
    Make("Corner", DropdownFrame)
    Make("Stroke", DropdownFrame)

    local TitleLabel = InsertTheme(Create("TextLabel", DropdownFrame, {
        Text = Title,
        Font = Enum.Font.GothamBold,
        TextSize = 14,
        TextColor3 = Theme["Color Text"],
    ...
    local DropFrame = InsertTheme(Create("Frame", DropdownFrame, {
    ...
    local UIList = Create("UIListLayout", ScrollFrame, {
        Padding = UDim.new(0, 5),
